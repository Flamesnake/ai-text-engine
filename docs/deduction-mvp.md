...
`hint` 在证据不足时提供非剧透调查方向。它应描述“去哪里或与谁互动”，不能直接列出缺失证据名称或答案。
...
校验器拒绝不存在的证据引用和无证据要求的推论。路径探索把推理板视为场景外动作，同时探索暂不确认和当前可确认的推论状态。
...
管家声称停电时一直在厨房。玩家获得“停在 22:10 的厨房时钟”和“管家 22:20 才回厨房的女仆证词”，在推理板组合两条证据，确认“不在场证明不成立”，从而解锁揭穿管家的真相结局。
